 ...
 *  Make three subclasses named ‘BankA’, ‘BankB’ and ‘BankC’ with a method with the same name ‘getBalance’ which returns the amount deposited 
 *  in that particular bank. Call the method ‘getBalance’ by the object of each of the three banks.
 */
